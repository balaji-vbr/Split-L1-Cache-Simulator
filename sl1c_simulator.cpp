...
int data_cache_hit 	= 0; 				// Data Cache Hits count
int data_cache_miss = 0; 				// Data Cache Misses count
int data_cache_read = 0; 				// Data Cache read count
int data_cache_write = 0; 				// Data Cache write count

int instruction_cache_hit	= 0; 		// Instruction Cache Hits count
int instruction_cache_miss 	= 0; 		// Instruction Cache Misses count
int instruction_cache_read 	= 0; 		// Instruction Cache read count
char MESI_name;
float hitratio;
float DATAhitratio;
float INSTRhitratio;
...
//----------------------------------Print Contents---------------------------------
					...
					if (INSTRCACHE[i].LINE[j].MESI!=I) {
						...
						for (int k=0;k<4;k=k+1) {
							if (INSTRCACHE[i].LINE[k].MESI!=I) {
								cout<<" "<<std::hex<<INSTRCACHE[i].LINE[k].TAG<<"("<<getMesiName(INSTRCACHE[i].LINE[k].MESI)<<")["<<DATACACHE[i].LINE[k].LRU<<"]";
							}
		...
		cout<<"| Number of Cache Hits:    \t|  "<<data_cache_hit<<"       \t  |"<<endl;
		cout<<"| Number of Cache Misses:   \t|  "<<data_cache_miss<<"     \t  |"<<endl;
		cout<<"| Number of Cache Reads:   \t|  "<<data_cache_read<<"      \t  |"<<endl;
		cout<<"| Number of Cache Writes:   \t|  "<<data_cache_write<<"    \t  |"<<endl;
		...
		cout<<"------------------------------------------"<<endl;
		std::cout << std::fixed << std::setprecision(4);
		cout<<"| Number of Cache Hits:    \t|  "<<instruction_cache_hit<<"       \t  |"<<endl;
		cout<<"| Number of Cache Misses:   \t|  "<<instruction_cache_miss<<"     \t  |"<<endl;
		cout<<"| Number of Cache Reads:   \t|  "<<instruction_cache_read<<"      \t  |"<<endl;
		...
		cout<<"------------------------------------------"<<endl;
		std::cout << std::fixed << std::setprecision(4);
		cout<<"| Number of Cache Hits:    \t|  "<<data_cache_hit+instruction_cache_hit<<"       \t  |"<<endl;
		cout<<"| Number of Cache Misses:   \t|  "<<data_cache_miss+instruction_cache_miss<<"    \t  |"<<endl;
		cout<<"| Number of Cache Reads:   \t|  "<<data_cache_read + instruction_cache_read<<"   \t  |"<<endl;
		cout<<"| Number of Cache Writes:   \t|  "<<data_cache_write<<"      \t  |"<<endl;
